...
void OLED_DrawRect(u8 x0, u8 y0, u8 x1, u8 y1)//画一个点
{
	u8 i = 0, j = 0;
...
void OLED_DrawCirc(u8 x, u8 y, u8 r)//画一个点
{
	u8 i = 0, j = 0;
